...
local function on_paint(ctx)
	...
	for i=1, #value do
		...
		if value_temp == "Logo" then
			...
			client_draw_text(ctx, x_text+10, y_text, 255, 255, 255, a_text, nil, 0, "game")
			client_draw_text(ctx, x_text+37, y_text, r_sense, g_sense, b_sense, a_text, nil, 0, "sense")
		elseif value_temp == "Custom text" then
			client_draw_text(ctx, x_text+9, y_text, 255, 255, 255, a_text, nil, 0, custom_name_text)
		elseif value_temp == "FPS" then
			...
			client_draw_text(ctx, x_text+48, y_text, fps_r, fps_g, fps_b, a_text, "r", 0, fps, " fps")
		elseif value_temp == "Ping" then
			...
			client_draw_text(ctx, x_text+47, y_text, ping_r, ping_g, ping_b, a_text, "r", 0, ping, "ms")
		elseif value_temp == "Velocity" then
			...
			if vel_x ~= nil then
				...
				client_draw_text(ctx, x_text+38, y_text, 255, 255, 255, a_text, "r", 0, velocity)
				client_draw_text(ctx, x_text+38, y_text+3, 255, 255, 255, a_text, "-", 0, "u / t")
			end
		elseif value_temp == "Time" or value_temp == "Time + seconds" then
			...
			client_draw_text(ctx, time_center, y_text, 255, 255, 255, a_text, "r", 0, hours)
			client_draw_text(ctx, time_center+1, y_text, 255, 255, 255, a_text, "", 0, ":")
			client_draw_text(ctx, time_center+4, y_text, 255, 255, 255, a_text, "", 0, minutes)
			...
			if value_temp == "Time + seconds" then
				...
				client_draw_text(ctx, time_center+1, y_text, 255, 255, 255, a_text, "", 0, ":")
				client_draw_text(ctx, time_center+4, y_text, 255, 255, 255, a_text, "", 0, seconds)
			end
		end
		...
		if #value > i then
			client_draw_text(ctx, x_text, y_text, 255, 255, 255, a_text, nil, 0, " | ")
		end
	end
end
